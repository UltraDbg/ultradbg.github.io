//#region node_modules/.nitro/vite/services/ssr/assets/site-BwUrXqTQ.js
var site = {
	name: "Ultra Dbg",
	handle: "@ultradbg",
...
var experience = [{
	...
	redacted: true,
	description: "Rewrote a manual spreadsheet pipeline into a graphical application using Microsoft Power Apps, implementing full CRUD operations while strictly following the company’s security practices."
}];
var projects = [{
	slug: "nimkit",
	title: "nimkit",
	description: "A Cargo-like project lifecycle tool for Nim — init, build, test, and ship without the usual ceremony.",
	tags: [
		"Nim",
		"CLI",
		"Tooling"
	...
	slug: "nimvirt",
	title: "nimvirt",
	description: "An experiment in code virtualization written in Nim — protect, obfuscate, and study program semantics at the VM layer.",
	tags: [
		"Nim",
		"Virtualization",
		"Reverse engineering"
...
//#endregion
export { site as a, projects as i, experience as n, socials as o, featuredLinks as r, education as t };
