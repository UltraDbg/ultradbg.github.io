...
date: 2026-06-02
excerpt: nimkit is a project lifecycle tool for Nim. The point was not another wrapper — it was a calmer default path from init to build.
---
...
I refused to hide the compiler. If `nim c` is failing, wrapping it in poetry does not help. nimkit should make the happy path short and the unhappy path _legible_.
